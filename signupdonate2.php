...
if(empty($_POST['DonateOrgLocation']))
		{
     ...
     echo("<script>console.log('".$_SESSION['DonateOrgLocation']."');</script>");
   $_SESSION['DonateOrgLocation'] =  $_POST['DonateOrgLocation'];  
   echo("<script>location.href='signupdonate3.php'</script>") ; 
}
        ...
        <div class="row">
           ...
           <form method="post" action="signupdonate2.php" class="form-horizontal">
             ...
             <div class="col-lg-8">
                 ...
                 <input class="big-input" type="text" name="DonateOrgLocation" placeholder="Location">
