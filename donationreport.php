...
<h3>Welcome, <?php echo $_SESSION['ReceiveOrg']?></h3>
    ...
    <button onclick="location.href='welcomerecipient.php'" type="reset" class="btn btn-default">Back</button>
  ...
  <tbody>
    ...
    $sql = "SELECT item_id, item_name, item_claimed, item_quantity, item_donator, item_claimedby FROM items ORDER BY item_id desc";
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                if($row['item_claimed'] == 1 && $row['item_claimedby']== $_SESSION['ReceiveOrg'] ) {
                    ...
                    <td>{$row['item_donator']}</td>   
                     <td><a href='donationreport.php?remove=true&item_id={$row['item_id']}' class='text-danger'>X</a></td>   
                    </tr>"    ;
