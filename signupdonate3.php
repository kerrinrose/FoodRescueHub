...
if(empty($_POST['DonateOrgEmail']))
 ...
 $_SESSION['DonateOrgEmail'] =  $_POST['DonateOrgEmail'];  
     echo("<script>location.href='signupdonate4.php'</script>") ; 
}
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
           ...
           <form method="post" action="signupdonate3.php" class="form-horizontal">
               <p class="question">Sounds good. Contact Email?</p> 
               
             <div class="col-lg-8">
                  <span class="text-danger"><?php echo $error['Name']; ?></span>
                 <input class="big-input" type="text" name="DonateOrgEmail" value="" placeholder="Email">
