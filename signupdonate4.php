...
if(empty($_POST['DonateOrgPassword']))
		{
 ...
 $_SESSION['DonateOrgPassword'] =  $_POST['DonateOrgPassword'];  
     echo("<script>location.href='signupdonate5.php'</script>") ; 
}
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
           ...
           <form method="post" action="signupdonate4.php" class="form-horizontal">
               <p class="question">And lastly, a password.</p> 
               
                        <div class="col-lg-8">
                  <span class="text-danger"><?php echo $error['Name']; ?></span>
                 <input class="big-input" type="password" name="DonateOrgPassword" value="" placeholder="Password">
